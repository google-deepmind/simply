...
class PyTreeTest(absltest.TestCase):
  ...
  def test_load_dataclasses(self):
    tree1 = {
    ...
    res1 = pytree.load_dataclasses(tree1)
    ...
    with self.assertRaises(ValueError):
      pytree.load_dataclasses(tree2)
    tree2['a']['x'] = 4
    res2 = pytree.load_dataclasses(tree2)
    ...
    res3 = pytree.load_dataclasses(tree3)
  ...
  def test_dump_dataclasses(self):
    c = _C(a=_B(x=1), b=_B(x=1, y=2))
    self.assertEqual(
        pytree.dump_dataclasses(c),
        {
            '__dataclass__': '_C',
  ...
  def test_ndarray(self):
    ...
    self.assertEqual(pytree.dump_dataclasses(c), expected_dumped)
    loaded = pytree.load_dataclasses(expected_dumped)
