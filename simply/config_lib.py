...
MODELS_DIR = os.getenv('SIMPLY_MODELS', '~/.cache/simply/models/')

GEMMA2_2B_PT_CKPT_DIR = os.path.join(MODELS_DIR, 'gemma/GEMMA-2.0-2B-PT-ORBAX')
GEMMA2_9B_PT_CKPT_DIR = os.path.join(MODELS_DIR, 'gemma/GEMMA-2.0-9B-PT-ORBAX')
GEMMA2_27B_PT_CKPT_DIR = os.path.join(MODELS_DIR, 'gemma/GEMMA-2.0-27B-PT-ORBAX')
GEMMA2_2B_IT_CKPT_DIR = os.path.join(MODELS_DIR, 'gemma/GEMMA-2.0-2B-IT-ORBAX')

GEMMA3_1B_PT_CKPT_DIR = os.path.join(MODELS_DIR, 'gemma/GEMMA-3.0-1B-PT-ORBAX')
GEMMA3_4B_PT_CKPT_DIR = os.path.join(MODELS_DIR, 'gemma/GEMMA-3.0-4B-PT-ORBAX')
GEMMA3_12B_PT_CKPT_DIR = os.path.join(MODELS_DIR, 'gemma/GEMMA-3.0-12B-PT-ORBAX')
GEMMA3_27B_PT_CKPT_DIR = os.path.join(MODELS_DIR, 'gemma/GEMMA-3.0-27B-PT-ORBAX')
GEMMA3_12B_IT_CKPT_DIR = os.path.join(MODELS_DIR, 'gemma/GEMMA-3.0-12B-IT-ORBAX')
GEMMA3_27B_IT_CKPT_DIR = os.path.join(MODELS_DIR, 'gemma/GEMMA-3.0-27B-IT-ORBAX')

DEEPSEEK_QWEN_1P5B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/DeepSeek-R1-Distill-Qwen-1.5B/ORBAX')
DEEPSEEK_QWEN_7B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/DeepSeek-R1-Distill-Qwen-7B/ORBAX')
DEEPSEEK_QWEN_14B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/DeepSeek-R1-Distill-Qwen-14B/ORBAX')
DEEPSEEK_QWEN_32B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/DeepSeek-R1-Distill-Qwen-32B/ORBAX')

QWEN2p5_MATH_1p5B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/Qwen2.5-Math-1.5B/ORBAX')
QWEN2p5_MATH_7B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/Qwen2.5-Math-7B/ORBAX')
QWEN2p5_MATH_14B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/Qwen2.5-Math-14B/ORBAX')
QWEN2p5_MATH_32B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/Qwen2.5-Math-32B/ORBAX')
QWQ_32B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/QwQ-32B/ORBAX')

QWEN3_0P6B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/Qwen3-0.6B/ORBAX')
QWEN3_1P7B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/Qwen3-1.7B/ORBAX')
QWEN3_4B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/Qwen3-4B/ORBAX')
QWEN3_8B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/Qwen3-8B/ORBAX')
QWEN3_14B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/Qwen3-14B/ORBAX')
QWEN3_32B_CKPT_DIR = os.path.join(MODELS_DIR, 'qwen/Qwen3-32B/ORBAX')
...
@ExperimentConfigRegistry.register
@dataclasses.dataclass(frozen=True)
class Flops6e20TFM2BC4L2048BS1024(TFM1p7BLM1B):
...
@ExperimentConfigRegistry.register
@dataclasses.dataclass(frozen=True)
class Flops1e20TFM986MC4L2048BS512(Flops6e20TFM2BC4L2048BS1024):
...
@ExperimentConfigRegistry.register
@dataclasses.dataclass(frozen=True)
class Flops1e19TFM338MC4L2048BS512(Flops6e20TFM2BC4L2048BS1024):
...
@ExperimentConfigRegistry.register
@dataclasses.dataclass(frozen=True)
class Flops1e18TFM111MC4L2048BS256(Flops6e20TFM2BC4L2048BS1024):
...
@ExperimentConfigRegistry.register
@dataclasses.dataclass(frozen=True)
class Flops2e17TFM41MC4L2048BS128(Flops6e20TFM2BC4L2048BS1024):
...
@ExperimentConfigRegistry.register
@dataclasses.dataclass(frozen=True)
class Flops2e16TFM15MC4L2048BS128(Flops6e20TFM2BC4L2048BS1024):
...
class TransformerLMTestC4(TransformerLMTest):
  seq_len: int = 4096
  dataset_name: str = 'simply_det:c4.vb100864_openmix_v1.l4096'
